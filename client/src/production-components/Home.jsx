        ...
        <PanelProvider>
            <div style={{
                ...
                {(isMobile && activePanel === 1) && (
                    ...
                    >
                        <FirstPanel machines={machines}  handleItemClick={handleItemClick} />
                    </div>
                )}
                {(isMobile && activePanel === 2) && (
                    <div style={{
                        ...
                        <SecondPanel selectedItem={selectedItem} machines={machines} items={items} onItemClick={handleItemClick2} handleItemClick={handleItemClick} />
