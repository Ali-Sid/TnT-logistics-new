...
function NewItemCatalog({ selectedItem, onItemAdded, onCloseDialog }) {
    ...
    const [location, setLocation] = useState('Factory 1 - Dispatch Area');
    ...
    const handleSubmit = async (event) => {
        ...
        for (let i = 0; i < numberOfEntries; i++) {
            try {
                ...
                console.log(`Sending data:`, { itemName, itemID, skuNumber, currentDate: selectedDate, itemNumber: uniqueNumber, itemSelectedID, shift, location });
                ...
                <Box component="form" onSubmit={handleSubmit}
                    ...
                    <div style={{ width: isMobile && "100%" }}>
                        ...
                        <div style={{ margin: "10px" }}>
                            ...
                            <Typography mt="10px" variant='h6'>{location}</Typography>
                        </div>
