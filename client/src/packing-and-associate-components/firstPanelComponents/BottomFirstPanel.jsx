    ...
    const filterGroup = () => {
        if (!searchQuery) {
            ...
            const filteredItems = group.filter(item => // Changed here
                item.PItemName.toLowerCase().includes(searchQuery.toLowerCase()) ||
                item.PItemCode.toLowerCase().includes(searchQuery.toLowerCase())
            );
            ...
            <List>
                {itemsMaster.map((item) => (
                    <div key={item.PItemMasterID}>
                        ...
                        }} key={item.PItemMasterID}>
                            <ListItemText primary={item.PItemName} secondary={
                                <>
                                    <Typography sx={{
                                        display: 'inline'
