    ...
    const handleSubmit = async (event) => {
        ...
        for (let i = 0; i < numberOfEntries; i++) {
            try {
                ...
                const response = await axios.post('http://localhost:3000/addItemMaster', { itemName, itemID, skuNumber, itemCode, itemNumber: uniqueNumber }, {
                    headers: {
                ...
                <Box component="form" onSubmit={handleSubmit}
                    ...
                    <div style={{ width: isMobile && "100%" }}>
                        ...
                        <div style={{ width: "90%", marginLeft: "7px", display: "flex", flexDirection: "column", marginTop: "10px", gap: "10px", justifyContent: "space-around", alignItems: "center" }}>
                            ...
                            <Button fullWidth startIcon={<DisabledByDefault />} variant='outlined' color='error' onClick={handleCancel} start sx={{ textTransform: 'none', fontSize: "16px" }}>Cancel</Button>
                        </div>
                    </div>
                </Box>
            </Box>
